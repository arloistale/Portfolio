...
export default function Navbar() {
    ...
    return (
      <nav className={`z-50 rounded-bl-3xl rounded-br-3xl fixed top-0 left-0 w-full p-4 transition-all duration-300 ${scrolled ? 'bg-skyegg-orange' : 'md:bg-transparent bg-skyegg-orange'}`}>
        ...
        <div className="md:hidden mt-4">
          <Link href="/about" className="block text-white mb-2">
            About
          </Link>
          <Link href="/services" className="block text-white mb-2">
            Services
          </Link>
