...
export default function Home() {
  return (
    <main className="flex flex-col">
      <div className='bg-hero-gradient px-4 lg:px-24 -mt-3 lg:mt-0 flex flex-col lg:flex-row relative w-full min-h-screen h-auto justify-start lg:justify-between items-center'>
